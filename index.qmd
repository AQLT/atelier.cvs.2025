...
Supports de cours et exercices du séminaire régional sur la correction des variations saisonnières avec R et JDemetra+ du 18 au 22 août 2025.
...
6. Autres programmes : [3-imae-calage](R-macronia/3-imae-calage.R) et [4-cvs-indirecte](R-macronia/4-cvs-indirecte.R)
...
- Workspace et données associées à la Macronie\ : [macronia.zip](data/macronia.zip)
...
Ces supports de cours sont librement réutilisable sous © 2025 Alain Quartier-la-Tente, FMI [CC BY-NC-SA 4.0 <img src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" alt="Licence Creative Commons" style="display: inline-block; margin: 0"/>](http://creativecommons.org/licenses/by-nc-sa/4.0/).
