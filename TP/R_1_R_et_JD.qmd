...
En cas de problème d'installation voir la page : <https://github.com/rjdverse/rjdemetra/wiki/Installation-manual>.
...
Les fonctionnalités de `RJDemetra` (et les nouvelles) sont divisées en plusieurs packages disponibles sous <https://github.com/rjdverse>.
