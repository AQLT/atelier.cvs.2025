...
if (! file.exists( file.path(dir_dl, "macronia.xml"))) {
	download.file("https://aqlt.github.io/atelier.cvs.2025/data/macronia.zip",
...
packages_to_install <- c(
  "RJDemetra", "remotes", "rjdqa", "ggdemetra", "rjdmarkdown", "rjwsacruncher",
...
::: callout-important
## En V3
Pour les modèles V3 vous pouvez utiliser le package [`ggdemetra3`](https://github.com/AQLT/ggdemetra3).
:::
...
::: callout-important
## En V3
Pour les modèles V3 vous pouvez utiliser le package [`rjd3report`](https://github.com/AQLT/rjd3report).
:::
...
Il n'y a pas d'équivalent en V3 mais les fonctions seront à termes dans le package [`rjd3report`](https://github.com/AQLT/rjd3report).
:::
